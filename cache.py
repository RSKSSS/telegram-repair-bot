...
_cache_ttl: Dict[str, int] = {
    'users': 300,       # 5 минут для пользователей (увеличено для снижения нагрузки)
    'orders': 120,      # 2 минуты для заказов (увеличено для снижения нагрузки)
    'technicians': 300, # 5 минут для мастеров (увеличено для снижения нагрузки)
    'assignments': 120, # 2 минуты для назначений (увеличено для снижения нагрузки)
    'stats': 600,       # 10 минут для статистики (увеличено для снижения нагрузки)
    'misc': 300         # 5 минут для прочего кэша (увеличено для снижения нагрузки)
}
